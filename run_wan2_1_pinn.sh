...
PROMPT="${PROMPT:-A nacho chip is dipped into a bowl of salsa.}"
NEGATIVE_PROMPT="${NEGATIVE_PROMPT:-色调艳丽，过曝，静态，细节模糊不清，字幕，风格，作品，画作，画面，静止，整体发灰，最差质量，低质量}"
ENABLE_PINN="${ENABLE_PINN:-1}"
CHECKPOINT_PATH="/home/dataset-assist-0/algorithm/cong.wang/DiffSynth-Studio/models/train/wan21_stage2_fullpinn8/step-18000.pt"
OUTPUT_PATH="${OUTPUT_PATH:-./video_wan21_chip.mp4}"
HEIGHT="${HEIGHT:-480}"
WIDTH="${WIDTH:-832}"
