...
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/phygenbench_videos_wan21_pinn_batch}"
CHECKPOINT_PATH="${CHECKPOINT_PATH:-${CHECKPOINT:-/home/dataset-assist-0/algorithm/cong.wang/DiffSynth-Studio/models/train/wan21_stage2_fullpinn/step-2000.pt}}"
